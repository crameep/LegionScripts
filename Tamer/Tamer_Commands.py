...
# ============================================================
#
# Quick pet command hotkeys with a clean GUI. Great for combat
# when you need fast access to All Kill, Guard, Follow, and Stay.
#
# Features:
#   - Hotkey-driven commands (TAB, 1, 2, etc.)
...
def save_pets():
    ...
    for pet in ATTACK_PETS:
        ...
        parts.append(pet["name"] + ":" + str(pet["serial"]) + ":" + active_str)
    
    API.SavePersistentVar(PETS_KEY, "|".join(parts), API.PersistentVar.Char)
